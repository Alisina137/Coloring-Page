...
import { Palette, Library, BarChart2, BookOpen, Sun, UserCircle2, LayoutDashboard } from "lucide-react";
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "flex items-center gap-1.5 px-3 py-2 rounded-full font-medium transition-all duration-200 whitespace-nowrap text-sm",
                    isActive
